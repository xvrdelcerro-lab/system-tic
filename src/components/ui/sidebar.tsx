  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "duration-200 fixed inset-y-0 h-svh w-[--sidebar-width] bg-sidebar transition-[width] ease-linear",
  ...
  return (
    <Tooltip>
      <TooltipTrigger asChild>
        ...
        variant="ghost"
        className={cn(
          "h-11 w-11 p-0 flex items-center justify-center text-primary [&_svg]:h-6 [&_svg]:w-6",
          className
        )}
        onClick={(event) => {
          onClick?.(event)
        ...
        {...props}
      >
          <PanelLeft style={{ width: "32px", height: "32px" }} />
