...
export default function PhasesPage() {
  ...
  if (permissionLoading || !isClient || loading) {
    return (
    <ProtectedPage pageName="catalogs.phases" pageTitle="Phases">
        ...
        <DialogContent>
            <Form {...editForm}>
                <form onSubmit={editForm.handleSubmit(handleEditSubmit)}>
                    <DialogHeader>
                        <DialogTitle>{editingPhase ? t('editDialog.title', { phaseName: tData(`PhasesData.${editingPhase.name}` as any) }) : ""}</DialogTitle>
