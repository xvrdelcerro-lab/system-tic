    ...
    sortedMonths.forEach((monthKey) => {
      ...
      monthlyContent += `
        <div style="margin-bottom: 40px; page-break-inside: avoid; break-inside: avoid;">
          ...
          <table style="width: 100%; border-collapse: collapse; background: white; border: 1px solid #e5e7eb; border-top: none; page-break-inside: auto;">
            ...
            <tfoot style="display: table-footer-group;">
              <tr style="border-top: 2px solid #3560AD; background: #eff6ff; page-break-inside: avoid;">
                <td colspan="4" style="padding: 12px; font-weight: bold; font-size: 15px; color: #1e40af;">Month Total</td>
